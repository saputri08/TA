    ...
    <div class="row">
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    @if ($siswa->foto)
                    <img src="{{ url($siswa->foto) }}" class="img-fluid" alt="">
                    @else
                    ...
                    <form method="POST" action="{{ url('admin/siswa', $siswa->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="nis" class="form-control mb-3" placeholder="Masukan NIS" value="{{ $siswa->nis }}">
                                @error('nis')
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="nisn" class="form-control mb-3" placeholder="Masukan NISN" value="{{ $siswa->nisn }}">
                                @error('nisn')
                                <p class="text-danger" style="font-size: 12px">* {{ $message }}</p style="font-size: 12px">
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" name="nama" class="form-control mb-3" placeholder="Masukan Nama Lengkap" value="{{ $siswa->nama }}">
                                @error('nama')
                                <p class="text-danger" style="font-size: 12px">* {{ $message }}</p style="font-size: 12px">
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="tmp_lahir" class="form-control mb-3" placeholder="Masukan Tempat Lahir" value="{{ $siswa->tmp_lahir }}">
                                @error('tmp_lahir')
                                <p class="text-danger" style="font-size: 12px">* {{ $message }}</p style="font-size: 12px">
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="email" class="form-control mb-3" placeholder="Masukan Email" value="{{ $siswa->email }}">
                                @error('email')
                                <p class="text-danger" style="font-size: 12px">* {{ $message }}</p style="font-size: 12px">
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="alamat" class="form-control mb-3" placeholder="Masukan Alamat" value="{{ $siswa->alamat }}">
                                @error('alamat')
                                <p class="text-danger" style="font-size: 12px">* {{ $message }}</p style="font-size: 12px">
                                @enderror
                            </div>
