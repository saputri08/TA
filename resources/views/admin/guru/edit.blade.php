                    ...
                    <form method="POST" action="{{ url('admin/guru', $guru->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" value="{{ $guru->nip }}" name="nip" class="form-control mb-3" placeholder="Masukan NIP">
                                @error('nip')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" value="{{ $guru->nama_guru }}" name="nama_guru" class="form-control mb-3" placeholder="Masukan Nama">
                                @error('nama_guru')
                                <p class="text-danger" style="font-size: 12px">* {{ $message }}</p style="font-size: 12px">
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" value="{{ $guru->tgl_lahir }}" name="tanggal_lahir" class="form-control mb-3" placeholder="Masukan Tanggal Lahir">
                                @error('tanggal_lahir')
                                <p class="text-danger" style="font-size: 12px">* {{ $message }}</p style="font-size: 12px">
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" value="{{ $guru->tmp_lahir }}" name="tempat_lahir" class="form-control mb-3" placeholder="Masukan Tempat Lahir">
                                @error('tempat_lahir')
                                <p class="text-danger" style="font-size: 12px">* {{ $message }}</p style="font-size: 12px">
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" value="{{ $guru->email }}" name="email" class="form-control mb-3" placeholder="Masukan Email">
                                @error('email')
                                <p class="text-danger" style="font-size: 12px">* {{ $message }}</p style="font-size: 12px">
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" value="{{ $guru->alamat }}" name="alamat" class="form-control mb-3" placeholder="Masukan Alamat">
                                @error('alamat')
                                <p class="text-danger" style="font-size: 12px">* {{ $message }}</p style="font-size: 12px">
                                @enderror
                            </div>
