<x-app>
    <h5 class="m-0 font-weight-bold text-dark" style="text-align: center; font-size: 25px"> TAMBAH NILAI MAN 2 KETAPANG
    </h5>
    <hr>
                    ...
                    <form action="{{ url('admin/nilai') }}" method="post">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            <tbody>
                                ...
                                <input type="text" name="id_kelas" value="{{ $anggota->anggota->kelas->id }}"
                                    class="form-control" hidden>
                                <input type="text" name="semester"
                                    value="{{ $anggota->anggota->kelas->TahunAjar->deskripsi }}" hidden>
                                ...
                                <input type="text" name="tahun_mulai"
                                    value="{{ $anggota->anggota->kelas->TahunAjar->tahun_mulai }}" hidden>
                                <input type="text" name="tahun_selesai"
                                    value="{{ $anggota->anggota->kelas->TahunAjar->tahun_selesai }}" hidden>
                            </tbody>
                        </table>
                        <!-- SIKAP -->
                        <hr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @error('spiritual_sikap')
                                            <p class="text-danger" style="font-size: 12px">* {{ $message }}</p>
                                        @enderror
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <textarea class="form-control" cols="20" name="spiritual_sikap_keterangan" id=""></textarea>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <textarea class="form-control" cols="20" name="sosial_sikap_keterangan" id=""></textarea>
                                            @error('sosial_sikap_keterangan')
                                                <p class="text-danger" style="font-size: 12px">* {{ $message }}</p>
                                            @enderror
                                        </div>
                                    </td>
                            ...
                            <tbody>
                                ...
                                @foreach ($list_mapel as $mapel)
                                    @if ($mapel->id_kelas == $anggota->anggota->kelas->id)
                                        @if ($mapel->kelompok == 'A')
                                            <tr>
                                                <input type="text" name="mapel[{{ $mapel->id }}]"
                                                    value="{{ $mapel->id }}" hidden>
                                                <th>{{ $no++ }}</th>
                                                <td>{{ $mapel->nama_mapel }}</td>
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control nilai-pengetahuan"
                                                            name="nilai_pengetahuan[{{ $mapel->id }}]" required>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control kkm-pengetahuan"
                                                            value="78"
                                                            name="kkm_pengetahuan[{{ $mapel->id }}]" readonly>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text"
                                                            class="form-control predikat-pengetahuan"
                                                            name="predikat_pengetahuan[{{ $mapel->id }}]" readonly>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control nilai-keterampilan"
                                                            name="nilai_keterampilan[{{ $mapel->id }}]" required>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group">
                                                        <input type="text"
                                                            class="form-control predikat-keterampilan"
                                                            name="predikat_keterampilan[{{ $mapel->id }}]"
                                                            readonly>
                                                    </div>
                                                </td>
                                            </tr>
                        ...
                        <table class="col-md-6 table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="4" style="vertical-align: middle; text-align: center;">Predikat
                                    </th>
                                </tr>
                                <tr>
                                    ...
                                    @if ($mapel->id_kelas == $anggota->anggota->kelas->id)
                                        @if ($mapel->kelompok == 'A')
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <textarea class="form-control" cols="20" name="keterangan_pengetahuan[{{ $mapel->id }}]" id="" required></textarea>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group">
                                                        <textarea class="form-control" cols="20" name="keterangan_keterampilan[{{ $mapel->id }}]" id="" required></textarea>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endif
                        ...
                        <hr>
                        <div class="col-md-12">
                            <textarea class="form-control" name="catatan_wali" id="" cols="30" required></textarea>
                        </div>
