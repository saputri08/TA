...
<head>
    ...
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="{{ url('public') }}/admin-template/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- Theme style -->
...
<body class="hold-transition login-page"
    style="background-image: url('public/gambar.jpg');  background-size: cover; background-repeat: no-repeat;">
    <div class="login-box">
        <div class="login-logo">
            <a href="{{ url('public') }}/template-admin/index2.html"><b>MAN 2 KETAPANG</b></a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="{{ url('login') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Email/NIS/NIP" name="login">
