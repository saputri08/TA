<x-app>
    ...
    <form action="{{ url('guru/nilai', $siswa->id) }}" method="post">
        @csrf
        @method('PUT')
        <div class="card">
            <div class="row">
                <div class="col-md-12">
                    <div class="content">
                        <div class="card-body">
                            ...
                            <h6 class="text-center badge badge-danger" style="font-size: 15px; display: block; margin-left: auto; margin-right: auto;">Data Nilai Belum di Input</h6>
                            @else
                            <input type="hidden" name="id_anggota" value="{{ $nilai_tambahan->id_anggota }}" id="">
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <select name="spiritual_sikap" class="form-control" id="">
                                                <option value="{{ $nilai_tambahan->spiritual_sikap }}">{{ $nilai_tambahan->spiritual_sikap }}</option>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="spiritual_sikap_keterangan" value="{{ $nilai_tambahan->spiritual_sikap_keterangan }}">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <select name="sosial_sikap" class="form-control" id="">
                                                <option value="{{ $nilai_tambahan->sosial_sikap }}">{{ $nilai_tambahan->sosial_sikap }}</option>
                                                <option value="SANGAT BAIK">SANGAT BAIK</option>
                                                <option value="BAIK">BAIK</option>
                                                <option value="CUKUP">CUKUP</option>
                                                <option value="BURUK">BURUK</option>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="sosial_sikap_keterangan" value="{{ $nilai_tambahan->sosial_sikap_keterangan }}">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-bordered table-striped">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control text-center nilai-pengetahuan" name="nilai_pengetahuan[{{ $item->id }}]" value="{{ $item->nilai_pengetahuan }}">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control text-center kkm-pengetahuan" name="kkm_pengetahuan[{{ $item->id }}]" value="78" readonly>
                                        </td>
                                        <td>
                                            <input type="text" class="form-control text-center predikat-pengetahuan" name="predikat_pengetahuan[{{ $item->id }}]" value="{{ $item->predikat_pengetahuan }}" readonly>
                                        </td>
                                        <td>
                                            <input type="text" class="form-control text-center nilai-keterampilan" name="nilai_keterampilan[{{ $item->id }}]" value="{{ $item->nilai_keterampilan }}">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control text-center predikat-keterampilan" name="predikat_keterampilan[{{ $item->id }}]" value="{{ $item->predikat_keterampilan }}" readonly>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            ...
                            <table class="table table-bordered table-striped">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->mapel->nama_mapel }}</td>
                                        <td>
                                            <input type="text" class="form-control" name="keterangan_pengetahuan[{{ $item->id }}]" value="{{ $item->keterangan_pengetahuan }}">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" name="keterangan_keterampilan[{{ $item->id }}]" value="{{ $item->keterangan_keterampilan }}">
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            ...
                            <table class="table table-bordered table-striped" id="ekskulTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="ekskul_kegiatan[{{ $item->id }}]" value="{{ $item->ekskul_kegiatan }}">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control text-center" name="ekskul_nilai[{{ $item->id }}]" value="{{ $item->ekskul_nilai }}">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" name="ekskul_keterangan[{{ $item->id }}]" value="{{ $item->ekskul_keterangan }}">
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                            <input type="button" class="btn btn-primary mt-2" id="addRow" value="Tambah Row">
                            <!-- END EKSTRAKURIKULER -->
                            <!-- PRESTASI -->
                            <hr>
                            ...
                            <table class="table table-bordered table-striped" id="prestasiTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">{{ $no++ }}</td>
                                        <td>
                                            <input type="text" class="form-control" name="prestasi[{{ $item->id }}]" value="{{ $item->prestasi }}">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" name="keterangan_prestasi[{{ $item->id }}]" value="{{ $item->keterangan }}">
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                            <input type="button" class="btn btn-primary mt-2" id="addPrestasiRow" value="Tambah Row">
                            <!-- END PRESTASI -->
                            <!-- KETIDAKHADIRAN -->
                            <hr>
                            ...
                            <table class="table table-bordered table-striped">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Sakit</td>
                                        <td>
                                            <input type="text" class="form-control text-center" name="sakit" value="{{ $nilai_tambahan->sakit }}">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>Izin</td>
                                        <td>
                                            <input type="text" class="form-control text-center" name="izin" value="{{ $nilai_tambahan->izin }}">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control text-center" name="tanpaketerangan" value="{{ $nilai_tambahan->tanpaketerangan }}">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <div class="col-md-12">
                                ...
                                <select name="keterangan_lulus" class="form-control" id="">
                                    <option value="{{ $nilai_tambahan->keterangan_lulus }}">{{ $nilai_tambahan->keterangan_lulus }}</option>
                            ...
                            @endif
                            <div class="mt-4">
                                <button type="submit" class="btn btn-primary float-right"><i class="fa fa-save"></i> Simpan Perubahan</button>
                            </div>
                            @endempty
                        </div>
                    </div>
