<x-app>
    ...
    <hr>
    <x-template.button.back-button url="guru/nilai" />
    <div class="card">
        <div class="mt-3">
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a href="{{ url('guru/nilai/' . $anggota->siswa->id . '/' . $anggota->anggota->id_kelas . '/' . $anggota->anggota->tahunAjar->deskripsi . '/edit') }}"
                                        ...
                                        <a href="{{ url('guru/nilai/' . $anggota->siswa->id . '/' . $anggota->anggota->id_kelas. '/' . $anggota->anggota->tahunAjar->deskripsi) }}/detail"
                                            class="btn btn-dark"><span class="fa fa-info"></span> Detail Nilai</a>
                                        <a href="{{ url('guru/nilai/' . $anggota->siswa->id . '/' . $anggota->anggota->id_kelas . '/' . $anggota->anggota->tahunAjar->deskripsi . '/edit') }}"
                                            class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
                                        <a href="{{ url('guru/nilai/' . $anggota->siswa->id . '/' . $anggota->anggota->id_kelas . '/' . $anggota->anggota->tahunAjar->deskripsi) }}"
