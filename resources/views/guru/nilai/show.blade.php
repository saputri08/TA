                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            <a href="{{ url('guru/nilai/' . $anggota->siswa->id . '/' . $anggota->anggota->id_kelas) }}/detail"
                                                class="btn btn-dark"><span class="fa fa-info"></span> Detail Nilai</a>
                                            <a href="{{ url('guru/nilai/' . $anggota->siswa->id . '/' . $anggota->anggota->id_kelas . '/edit') }}"
                                                class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
                                            <a href="{{ url('guru/nilai/' . $anggota->siswa->id . '/' . $anggota->anggota->id_kelas) }}"
