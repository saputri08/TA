<x-app>
    <h5 class="m-0 font-weight-bold text-dark" style="font-size: 25px"> SELAMAT DATANG , {{ Auth::guard('kepsek')->user()->nama_kepsek }}</h5>
    <hr>
    <br>
    <div class="row">
        <div class="col-md-7">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <dl class="row" style="color:dark;">
                                ...
                                <dd class="col-10">: {{ Auth::guard('kepsek')->user()->nama_kepsek }}</dd>
                                <dt class="col-2">NIP</dt>
                                <dd class="col-10">: {{ Auth::guard('kepsek')->user()->nip }}</dd>
                                <dt class="col-2">JABATAN</dt>
                                <dd class="col-10">: KEPALA SEKOLAH</dd>
                            </dl>
                        </div>
                    </div>
                </div>
