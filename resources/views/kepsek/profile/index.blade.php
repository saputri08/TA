<x-app>
    <h5 class="m-0 font-weight-bold text-dark" style="text-align: center; font-size: 25px"> PROFILE KEPALA SEKOLAH</h5>
    <hr>
    <div class="row">
        <div class="col-md-3">
            <div class="card">
        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">
                    <a href="{{ url('kepsek/profile', $user->id) }}/edit" class="btn btn-warning btn-tone btn-sm float-right mt-3 mb-3"><i class="fas fa-edit"></i> Edit Data</a>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <dt class="font-weight-bold">NAMA LENGKAP</dt>
                            <dd>{{ $user->nama_kepsek }}</dd>
                        </div>
                        <div class="col-md-6">
