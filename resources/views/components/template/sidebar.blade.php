    ...
    <div class="sidebar">
        ...
        <nav class="mt-4">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/kepsek') }}" class="nav-link {{request()->is('admin/kepsek') ? 'active' : ''}}"">
                        <i class=" nav-icon fas fa-user text-sm text-green-500"></i>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/tahun-ajar') }}" class="nav-link {{request()->is('admin/tahun-ajar') ? 'active' : ''}}"">
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/anggota') }}" class="nav-link {{request()->is('admin/anggota') ? 'active' : ''}}"">
                        ...
                        <p class="text uppercase"> Data Anggota</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ url('admin/nilai') }}" class="nav-link {{request()->is('admin/nilai') ? 'active' : ''}}"">
                ...
                <li class="nav-item">
                    <a href="{{ url('siswa/nilai') }}" class="nav-link {{request()->is('siswa/nilai') ? 'active' : ''}}"">
                        <i class=" nav-icon fas fa-clipboard-list text-sm text-green-500"></i>
                        <p class="text uppercase">Data Nilai</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ url('guru/dashboard') }}" class="nav-link {{request()->is('guru/dashboard') ? 'active' : ''}}">
                        <i class=" nav-icon fas fa-tachometer-alt text-sm text-blue-500"></i>
                        <p class="text uppercase">Dashboard</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ url('guru/anggota') }}" class="nav-link {{request()->is('guru/anggota') ? 'active' : ''}}"">
                        <i class=" nav-icon fas fa-house-user text-sm text-green-500"></i>
                        <p class="text uppercase"> Data Anggota</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ url('kepsek/dashboard') }}" class="nav-link {{request()->is('kepsek/dashboard') ? 'active' : ''}}">
                        <i class=" nav-icon fas fa-tachometer-alt text-sm text-blue-500"></i>
                        <p class="text uppercase">Dashboard</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ url('kepsek/anggota') }}" class="nav-link {{request()->is('kepsek/anggota') ? 'active' : ''}}"">
                        <i class=" nav-icon fas fa-clipboard-list text-sm text-green-500"></i>
                        <p class="text uppercase">Data Anggota</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ url('kepsek/nilai') }}" class="nav-link {{request()->is('kepsek/nilai') ? 'active' : ''}}"">
                        <i class=" nav-icon fas fa-house-user text-sm text-green-500"></i>
                        <p class="text uppercase"> Data Nilai</p>
                    </a>
                </li>
