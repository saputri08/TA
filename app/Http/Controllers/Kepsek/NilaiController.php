...
class NilaiController extends Controller
{
    ...
    public function nilaiDetail($id_siswa, $id_kelas)
    {
        ...
        return view('kepsek.nilai.detail', compact('nilai', 'nilai_tambahan', 'siswa', 'ekskul', 'prestasi', 'anggota', 'kelas'));
    }
    ...
    public function cetakData($id_siswa, $id_kelas)
    {
        ...
        return view('kepsek.nilai.cetak-nilai', compact('nilai', 'nilai_tambahan', 'siswa', 'ekskul', 'prestasi', 'anggota', 'kelas', 'guru', 'kepsek'));
    }
