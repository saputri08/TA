...
class NilaiController extends Controller
{
    public function index()
    {
        ...
        // Ambil nilai dari model Nilai berdasarkan id_siswa
        $data['list_nilai'] = AnggotaGrup::where('id_siswa', $siswaId)->get();
    ...
    public function show($kelas)
    {
        ...
        return view('siswa.nilai.show', $data);
    }
    ...
    public function edit($id_siswa, $id_kelas)
    {
        ...
        return view('siswa.nilai.edit', compact('nilai', 'nilai_tambahan', 'siswa', 'ekskul', 'prestasi', 'anggota', 'kelas', 'list_mapel'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('siswa/nilai/' . $id_anggota)->with('success', 'Data Berhasil Ditambahkan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $id_anggota = request('id_anggota');
        return redirect('siswa/nilai/' . $id_anggota)->with('success', 'Data berhasil diperbarui.');
    }
    ...
    public function nilai($anggota)
    {
        ...
        return view('siswa.nilai.nilai', compact('anggota', 'list_mapel'));
    }
